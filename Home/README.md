...
面向资产安全与高可靠性的主链网络，是生态的结算与数据可用性层。

- 兼容 EVM，支持智能合约与丰富生态
- GateMint 共识，提供稳定、快速、即时最终性
- 原生支持 Blob（EIP-4844），降低 L2 数据成本
- 由 GT 质押与治理保障网络安全

[进入 GateChain 文档 »](../GateChain/status/README.md)
...
- 5,700+ TPS、约 1s 出块，低交易费用
- L2 执行费（EIP-1559）+ L1 数据费（Blob）组合
